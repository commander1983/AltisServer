...
life_drugged = life_drugged_moon;
life_drugged_duration = life_drugged_moon_duration;
...
resetCamShake;
	...
	if(life_drugged < 0 || !Alive player) then { player setVariable["drug_moon",false,true]; life_drugged = -1; };
