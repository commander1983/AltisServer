...
life_drugged = life_drugged_meth;
life_drugged_duration = life_drugged_meth_duration;
...
resetCamShake;
	...
	if(life_drugged < 0 || !Alive player) then { player setVariable["drug_meth",false,true]; life_drugged = -1; };
