...
if(!alive player) exitWith {life_action_inUse = false; _ui cutRsc["osefStatusBar","PLAIN"];};
if(life_interrupted) exitWith {life_interrupted = false; titleText[localize "STR_NOTF_ActionCancel","PLAIN"]; life_action_inUse = false; _ui cutRsc["osefStatusBar","PLAIN"];};
