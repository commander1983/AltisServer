[] spawn  {
	...
	_fnc_battery =
	{
		...
		else
		{
			...
			{
				case 30: {hint "Dein Handy-Akku hat nur noch 30%.";};
				case 20: {hint "Dein Handy-Akku hat nur noch 20%.";};
				case 10: {hint "Dein Handy-Akku hat nur noch 10%.";};
			};
		};
	};
...
[] spawn
{
	...
	while{true} do
	{
		...
		if(license_civ_rebel) then {(unitBackpack player) setObjectTextureGlobal [0,""];};
