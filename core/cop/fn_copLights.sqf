...
switch (typeOf _vehicle) do {
	case "B_Quadbike_01_F": {_attach = [[-0.1, 1, -0.7],[0.1, 1, -0.7]]; };
	...
	case "O_MRAP_02_F": { _attach = [[-0.15, 0.8, -0.3], [0.15, 0.8, -0.3]]; }; 
	case "B_Heli_Transport_01_F": { _attach = [[-0.37, 0.0, 0.56], [0.37, 0.0, 0.56]]; };
