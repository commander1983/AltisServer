...
if(isNil "_criminal") exitWith {hint "Fehler beim Laden";};
if(typeName _criminal != "ARRAY") exitWith {hint "Fehler beim Laden";};
if(count _criminal == 0) exitWith {hint "Fehler beim Laden";};
