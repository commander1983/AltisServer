...
ctrlSetText[601,format["Geld: %1€",[ja_dzep] call life_fnc_numberText]];

switch (_shop) do
{
	case "reb":
	{
		ctrlSetText[2505,"Altis Rebellen Shop"];
		ctrlShow[2503,false];
		ctrlShow[2513,false];
		ctrlShow[2514,false];
	};
	...
	case "copdonator":
	{
		ctrlSetText[2505,"Polizei Donator Shop"];
		ctrlShow[2503,false];
	};	
	
	case "gun":
	{
		ctrlSetText[2505,"McGarrys Waffenladen"];
		ctrlShow[2503,false];
		ctrlShow[2513,false];
		ctrlShow[2514,false];
	};
	...
	case "dive":
	{
		ctrlSetText[2505,"Altis Tauchclub Shop"];
		ctrlShow[2503,false];
		ctrlShow[2510,false];
		ctrlShow[2511,false];
		ctrlShow[2513,false];
	...
	case "gen":
	{
		ctrlSetText[2505,"Gemischtwaren-Laden"];
		ctrlShow[2503,false];
	};
