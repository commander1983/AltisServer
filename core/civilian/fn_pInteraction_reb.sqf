...
private["_display","_curTarget","_bUnrestrain","_bEscort","_bPutInCar","_bTorture","_bHandy","_bMask"];
if(!dialog) then 
{
...
_bHandy = _display displayCtrl 2407;
_bMask = _display displayCtrl 2408;
...
//Set _bHandy Button
_bHandy ctrlSetTooltip "Handy entnehmen";
_bHandy buttonSetAction "[life_pInact_curTarget] call life_fnc_HandyEntnehmen; closeDialog 0;";

//Set _bMask Button
_bMask ctrlSetTooltip "Maske entfernen";
_bMask buttonSetAction "[life_pInact_curTarget] spawn life_fnc_removeMaskdrop; closeDialog 0;";
