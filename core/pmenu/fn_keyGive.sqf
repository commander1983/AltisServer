...
if(isNil "_vehicle" OR isNull _vehicle) exitWith {hint "Du hast keinen Schlüssel ausgewählt!";};
...
hint format["Du hast %1 den Schlüssel von/vom %2 gegeben.",_unit getVariable["realname",name _unit],typeOf _vehicle];
