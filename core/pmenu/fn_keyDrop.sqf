...
_sel = lbCurSel _list;
if(_sel == -1) exitWith {hint "Keinen Schlüssel ausgewählt.";};
...
if(player getVariable ["surrender", false]) exitWith {hint "Du kannst keine Schlüssel wegwerfen, während du dich ergibst!";};
