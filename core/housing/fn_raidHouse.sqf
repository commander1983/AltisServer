...
_cP = 0.01;
_cpRate = 0.00098;		// Von 0,0075 auf 0,0025 geändert -- Testweise. KA ob das geht.
...
if(_value > 0) then {
	[[0,"STR_House_Raid_Successful",true,[[_value] call life_fnc_numberText],_house getVariable "house_owner"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
