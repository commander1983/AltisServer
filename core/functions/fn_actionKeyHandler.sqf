...
{
	if(playerSide == west && player distance cursorTarget < 3 && !(player getVariable ["restrained", false])) then //Wenn COP
	{
	...
	_miscItems = ["Land_BottlePlastic_V1_F","Land_TacticalBacon_F","Land_Can_V3_F","Land_CanisterFuel_F","Land_Suitcase_F","Land_Axe_fire_F"];
