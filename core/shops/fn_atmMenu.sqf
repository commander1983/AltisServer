...
lbClear _units;
_text ctrlSetStructuredText parseText format["<img size='1.7' image='icons\bank.paa'/> %1€<br/><img size='1.6' image='icons\money.paa'/> %2€",[ja_pare] call life_fnc_numberText,[ja_dzep] call life_fnc_numberText];
