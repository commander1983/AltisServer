...
//Cop / Civ Pre Check
if((_this select 3) in ["bruce","dive","reb","kart","donate"] && playerSide != civilian) exitWith {hint localize "STR_Shop_NotaCiv"; closeDialog 0;};
if((_this select 3) in ["reb","donatereb"] && !license_civ_rebel) exitWith {hint localize "STR_Shop_NotaReb"; closeDialog 0;};
...
if((_this select 3) == "ems" && playerSide != independent) exitWith {hint "Du kannst diesen Shop nur als Sani Beamter benutzen"; closeDialog 0;};
...
sleep 1;					// Fix fuer Rangemaster Kleidung, wenn man im Shop nichts kauft?
