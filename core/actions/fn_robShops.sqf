...
if(currentWeapon _robber == "") exitWith { hint "Haha, du machst mir keine Angst! Hau bloss ab sonst setzt es was du Lappen!" };//is he trying to rob without a weapon? Lets taunt him a bit!
if(currentWeapon _robber == "Rangefinder" OR currentWeapon _robber == "Binocular") exitWith { hint "Willst du'n Passfoto oder warum schauste so dämlich??";};
