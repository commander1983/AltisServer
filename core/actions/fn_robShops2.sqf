...
if(_chance >= 15) then { "Tankstelle" hintC ["Der Kassierer hat den Alarmknopf betätigt!"]; [[4,format["<t color='#FF0000' font='TahomaB' size='1.7'>! ALARM !</t><br/><br/><t size='1.4'>%1 wird ausgeraubt!</t>", _shop]],"life_fnc_broadcast",west,false] spawn life_fnc_MP; };
