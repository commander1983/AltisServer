...
if(__GETC__(life_coplevel) < 2) exitwith {hint "Nur fuer Polizisten oder hoeher";};
...
_loadoutName = "Tasergewehr Vollausstattung";
_action = [
...
player addItemToBackpack "optic_ACO_grn_smg";
